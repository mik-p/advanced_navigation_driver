...
int OpenComport(char *comport, int baudrate)
{
  ...
  case 128000:
    ...
    break;
  case 230400:
    strcpy(baudr, "baud=230400 data=8 parity=N stop=1");
    break;
  case 256000:
    strcpy(baudr, "baud=256000 data=8 parity=N stop=1");
    break;
  case 460800:
    strcpy(baudr, "baud=460800 data=8 parity=N stop=1");
    break;
  case 500000:
    strcpy(baudr, "baud=500000 data=8 parity=N stop=1");
    break;
  case 921600:
    strcpy(baudr, "baud=921600 data=8 parity=N stop=1");
    break;
  case 1000000:
    strcpy(baudr, "baud=1000000 data=8 parity=N stop=1");
    break;
  case 2000000:
    strcpy(baudr, "baud=2000000 data=8 parity=N stop=1");
    break;
  default:
    printf("invalid baudrate\n");
    return (1);
